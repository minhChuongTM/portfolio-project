            ...
            {datas.data.map((item, i) => (
                <div key={i} className="grid md:grid-cols-12 gap-12 pt-6 text-xl">
                    <div className="col-span-2 flex items-center">
                        <div className="border-2 border-red-600 rounded-full hover:shadow-2xl hover:shadow-red-400/50">
                            <img
                    ...
                    <div className="col-span-10">
                        <Card className={"hover:shadow-2xl hover:shadow-red-400/50"}>
                            <CardHeader
                            ...
                            <CardFooter className={"flex justify-end"}>
                                <Link className="bg-red-500 text-white p-4 rounded-2xl hover:bg-green-500 hover:shadow-lg hover:shadow-red-300">
                                    view wedsite
                                </Link>
                            </CardFooter>
                        </Card>
