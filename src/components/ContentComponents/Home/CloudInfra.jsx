import { fullStackDev } from "@/portfolioData/PortfolioData";
import React from "react";

function CloudInfra(textColor) {
    const [lastItem] = fullStackDev.data.slice(1);
    return (
        <div className={`grid md:grid-cols-2 gap-6 pt-20 font-Fira-Sans font-normal ${textColor} font-Fira-Sans`}>
            <div className="pt-20">
                <h2 className="font-Fira-Sans text-4xl font-bold text-3xl">{lastItem.title}</h2>
                <ul className="list-none leading-10 font-Fira-Sans font-normal text-xl pt-6">
                    {lastItem.skills.map((skill, i) => (
                        <li key={i}>{skill}</li>
                    ))}
                </ul>
            </div>
