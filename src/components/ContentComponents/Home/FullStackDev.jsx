        ...
        <div className={` grid grid-cols-2 gap-6 ${textColor} transition-colors duration-300 pt-4`}>
            <div className="">
                ...
                >
                    ...
                    <rect
                        ...
                        height="2"
                        fill="#3f3d56"
                        style={{ filter: "drop-shadow(4px 5px 10px white)" }}
                    ></rect>
                </svg>
            </div>
            <div className="text-center">
                ...
                <div className="grid grid-cols-8 gap-4 text-7xl pt-6 text-center">
                    ...
                    <div className=" text-cyan-500">{iconFullStackDev.iconReact}</div>
                    <div className=" text-cyan-500">{iconFullStackDev.iconNodeJs}</div>
                    <div className=" text-cyan-500">{iconFullStackDev.iconCsharp}</div>
                    <div className=" text-cyan-500">{iconFullStackDev.ionPython}</div>
