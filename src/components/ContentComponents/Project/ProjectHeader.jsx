import { projectsHeader } from "@/portfolioData/PortfolioData";
import React from "react";

function ProjectHeader() {
    return (
        <div className="grid lg:grid-cols-2 gap-6 font-Fira-Sans text-xl">
            <div>
                <svg
                ...
                >
                    ...
                    <title></title>
                    <ellipse cx="843.39" cy="664.8" rx="192" ry="43" fill="#E3405F" opacity="0.1"></ellipse>
                    <g opacity="0.1">
                        <path
                    ...
                    <rect x="457" y="170.7" width="70.01" height="33.22" rx="8.57" fill="#E3405F" opacity="0.2"></rect>
                    <rect
                        x="598.84"
                        y="170.7"
                        width="70.01"
                    ...
                    <rect x="510.55" y="292.79" width="102.68" height="48.73" rx="8.57" fill="#E3405F"></rect>
                    <line
                        x1="492.29"
                        y1="170.7"
                        x2="491.38"
                    ...
                    <path
                        ...
                        fill="#46455b"
                    ></path>
                    <ellipse cx="175.43" cy="607.19" rx="17.52" ry="2.96" fill="#E3405F" opacity="0.1"></ellipse>
                    <path
            ...
            <div className="text-center flex items-center">
                <div>
                    <h1 className="pb-10 font-Fira-Sans font-bold text-5xl">{projectsHeader.title}</h1>
